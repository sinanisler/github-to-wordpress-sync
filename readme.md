...
> WARNING: ‼‼ It should be obvious, but I will write it anyway: this should be used on staging or development, NOT production sites. Of course, if you know what you are doing you can use it, but I wouldn’t recommend it.
